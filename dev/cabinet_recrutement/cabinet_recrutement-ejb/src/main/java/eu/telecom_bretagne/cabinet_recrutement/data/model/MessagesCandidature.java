...
/**
 * MessagesCandidature generated by hbm2java
 */
@Entity
@Table(name="messages_candidature"
    ,schema="public"
)
public class MessagesCandidature  implements java.io.Serializable {
    ...
    public MessagesCandidature() {
    }

	
    public MessagesCandidature(int id, Candidature candidature, OffresEmploi offresEmploi, Date dateEnvoi) {
        this.id = id;
        this.candidature = candidature;
        this.offresEmploi = offresEmploi;
        this.dateEnvoi = dateEnvoi;
    }
    public MessagesCandidature(int id, Candidature candidature, OffresEmploi offresEmploi, Date dateEnvoi, String corpsMessage) {
       this.id = id;
       this.candidature = candidature;
       this.offresEmploi = offresEmploi;
       this.dateEnvoi = dateEnvoi;
